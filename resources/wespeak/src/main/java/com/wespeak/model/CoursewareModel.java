...
public class CoursewareModel {
	...
	public CoursewareModel(Integer coursewareId, String coursewareName, String description, Integer active,
			String coursewarePath, Integer contributorId, String author, Integer numOfView, String userName) {
		super();
